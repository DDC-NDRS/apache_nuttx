...
#ifndef ZEPHYR_INCLUDE_DRIVERS_S32K1XX_GPIO_H_
#define ZEPHYR_INCLUDE_DRIVERS_S32K1XX_GPIO_H_
...
static inline int gpio_pin_configure_dt(const struct gpio_dt_spec* spec, gpio_flags_t extra_flags) {
    int ret;
 	...
 	ret = s32k1xx_pinconfig(spec->pinset);
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_S32K1XX_GPIO_H_ */
