...
#ifndef ZEPHYR_INCLUDE_DRIVERS_S32K1XX_PINCTRL_H_
#define ZEPHYR_INCLUDE_DRIVERS_S32K1XX_PINCTRL_H_
...
static inline int pinctrl_apply_state_direct(const struct pinctrl_dev_config* config,
	...
	int ret = s32k1xx_pinconfig(state->pins[0]);
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_S32K1XX_PINCTRL_H_ */
