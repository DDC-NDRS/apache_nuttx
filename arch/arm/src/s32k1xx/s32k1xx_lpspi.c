...
static int s32k1xx_lpspi_hwfeatures(struct spi_dev_s* dev, s32k1xx_lpspi_hwfeatures_t features);
#endif
...
static inline void s32k1xx_lpspi_set_delays(struct s32k1xx_lpspidev_s* priv, uint32_t delay_ns,
    ...
    clock_div_prescaler = inclock / (1 << ((s32k1xx_lpspi_getreg32(priv, S32K1XX_LPSPI_TCR_OFFSET) & LPSPI_TCR_PRESCALE_MASK) >>
...
static void s32k1xx_lpspi_bus_initialize(struct s32k1xx_lpspidev_s* priv) {
    ...
    s32k1xx_lpspi_setmode((struct spi_dev_s*)priv, SPIDEV_MODE1);
